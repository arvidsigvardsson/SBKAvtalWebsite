...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <form class="form-horizontal" method="post" action="avtal_detail.aspx">
        <div class="form-group row">
            <asp:Label ID="Label1" runat="server" Text="Förnamn" class="control-label col-sm-2 text-right"></asp:Label>
                <div class="col-sm-6">
            <asp:TextBox ID="firstnametb" runat="server" class="form-control" onkeyup="tbchange()" autofocus="true"></asp:TextBox>
            </div>
        </div>
    
        <div class="form-group row">
            <asp:Label ID="Label2" runat="server" Text="Efternamn" class="control-label col-sm-2 text-right"></asp:Label>
                <div class="col-sm-6">
        ...
        <div class="form-group row">
            <asp:Label ID="Label3" runat="server" Text="Belägenhetsadress" class="control-label col-sm-2 text-right"></asp:Label>
                <div class="col-sm-6">
         ...
         <div class="form-group row">
            <asp:Label ID="Label4" runat="server" Text="Postnummer" class="control-label col-sm-2 text-right"></asp:Label>
                <div class="col-sm-6">
         ...
         <div class="form-group row">
            <asp:Label ID="Label5" runat="server" Text="Postort" class="control-label col-sm-2 text-right"></asp:Label>
                <div class="col-sm-6">
         ...
         <div class="form-group row">
            <asp:Label ID="Label6" runat="server" Text="Telefonnummer" class="control-label col-sm-2 text-right"></asp:Label>
                <div class="col-sm-6">
         ...
         <div class="form-group row">
            <asp:Label ID="Label7" runat="server" Text="Epost" class="control-label col-sm-2 text-right"></asp:Label>
                <div class="col-sm-6">
